...
var flap = loadGameSound('./js/flap.wav', 3);

var coin = loadGameSound('./js/coin.wav', 1);

var punch = loadGameSound('./js/punch.wav', 1);
...
wing.img = loadGameImage('./js/wing.png'); // 150 x 131
...
wingfill.img = loadGameImage('./js/wingfill.png'); // 150 x 131
...
logo.showing = true;
logo.hiding = false;
logo.img = loadGameImage('./js/logo.png'); // 626 x 188
...
gameover.showing = false;
gameover.hiding = true;
gameover.img = loadGameImage('./js/gameover.png'); // 626 x 144
...
fbshare.showing = false;
fbshare.hiding = true;
fbshare.img = loadGameImage('./js/fbshare.png');
...
playagain.showing = false;
playagain.hiding = true;
playagain.img = loadGameImage('./js/playagain.png');
...
c2s.showing = true;
c2s.hiding = false;
c2s.img = loadGameImage('./js/clicktostart.png'); // 337 x 75
...
sndo.div.style.backgroundImage = 'url("./js/soundoff.png")';
sndo.has_sound = true;
...
ground.bit = loadGameImage('./js/ground.png');
